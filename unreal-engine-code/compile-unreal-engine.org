...
** make unreal engine compile in arm cpu macos, Fix Unreal Engine Xcode Metal Compiler Error

#+begin_src shell
xcodebuild -downloadComponent MetalToolChain
#+end_src

copy from [[https://www.youtube.com/watch?v=ek6yYxzVERY][How To Fix Unreal Engine Xcode Metal Compiler Error]]
