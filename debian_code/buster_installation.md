...
``` shell
wget -c https://nodejs.org/dist/v12.12.0/node-v12.12.0-linux-x64.tar.xz
sudo tar xaf node-v12.12.0-linux-x64.tar.xz -C /usr/local
echo "PATH=/usr/local/node-v12.12.0-linux-x64/bin:$PATH" >> ~/.zshrc
source ~/.zshrc
```
