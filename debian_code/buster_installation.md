...
``` shell
wget -c https://nodejs.org/dist/v13.5.0/node-v13.5.0-linux-x64.tar.xz
sudo tar xaf node-v13.5.0-linux-x64.tar.xz -C /usr/local
echo "PATH=/usr/local/node-v13.5.0-linux-x64/bin:$PATH" >> ~/.zshrc
source ~/.zshrc
```
