...
copy from
[[https://mirrors.tuna.tsinghua.edu.cn/help/crates.io-index.git/][Rust
crates.io 索引镜像使用帮助]]
...
copy from [[https://mirrors.ustc.edu.cn/help/crates.io-index.html][Rust
Crates 源使用帮助]]
...
see
[[https://github.com/google/evcxr/blob/master/evcxr_repl/README.md][Evcxr
REPL]] see [[https://github.com/rust-lang/rust/issues/1120][Implement a
Rust REPL #1120]]
...
copy from [[https://github.com/killercup/cargo-edit/issues/510][cargo
upgrade gives "unhandled error: invalid version 0 on
git_proxy_options"]]
...
copy from
[[https://stackoverflow.com/questions/67024062/change-nightly-rust-version][Change
nightly Rust version?]]
[[https://stackoverflow.com/questions/27758387/is-it-possible-to-download-previous-nightly-builds][Is
it possible to download previous nightly builds?]]
...
copy from [[https://github.com/rust-lang/rust/issues/88902][Compiling
large projects with over-heating CPUs causes weird crashes]]
...
copy from
[[https://stackoverflow.com/questions/29008127/why-are-rust-executables-so-huge/54842093#54842093][Why
are Rust executables so huge?]] also see
[[https://github.com/johnthagen/min-sized-rust][Minimizing Rust Binary
Size]]
...
:END:
copy from
[[https://robert.kra.hn/posts/2022-09-09-speeding-up-incremental-rust-compilation-with-dylibs/][Speeding
up incremental Rust compilation with dynamic libraries]]
